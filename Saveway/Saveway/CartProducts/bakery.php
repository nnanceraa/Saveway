...
$query = "SELECT ITEM_ID, ITEM_NAME, PRICE, DESCRIPTION, PHOTO_FILENAME FROM ITEM WHERE CATEGORY_ID ='4' ORDER BY ITEM_NAME";
...
if ($num > 0) {
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo "<div class='accord' style='height:100%;'>";
